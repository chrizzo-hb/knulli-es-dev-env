...
scp "$BASE_DIR/$LOCAL_DISTRIBUTION_DIR_NAME/output/$TARGET/build/knulli-emulationstation-custom/emulationstation" "$DEVICE_LOGIN:~/backup/emulationstation.newversion"
